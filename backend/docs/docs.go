...
const docTemplate = `{
    ...
    "paths": {
        "/admin/cards/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Данные для обновления card",
                        "name": "card",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/auth/login/moodle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для входа через Moodle",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.MoodleLoginRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/logout": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Refresh token (опционально)",
                        "name": "request",
                        "in": "body",
                        "schema": {
        ...
        "/auth/register/moodle": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для регистрации через Moodle",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/cards": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Deck ID для фильтрации cards",
                        "name": "deck_id",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для создания card",
                        "name": "card",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/decks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Course ID для фильтрации decks",
                        "name": "course_id",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для создания deck",
                        "name": "deck",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/decks/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Данные для обновления deck",
                        "name": "deck",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.GetWordInfoResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.StartTrainingSessionRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateUserCardRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateUserCardRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user-courses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.UserCourse"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для начала курса",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.StartCourseRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateUserCourseRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user-decks": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.UserDeck"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для начала деки",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.StartDeckRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateUserDeckRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vocabulary": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "User ID (UUID) для фильтрации слов",
                        "name": "user_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.PersonalVocabulary"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для создания слова",
                        "name": "vocabulary",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreatePersonalVocabularyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vocabulary/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Данные для обновления слова",
                        "name": "vocabulary",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdatePersonalVocabularyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vocabulary/{id}/stats": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Данные для обновления статистики",
                        "name": "stats",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateStatsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.CreatePersonalVocabularyRequest": {
            "type": "object",
            "required": [
                "translation",
                "user_id",
            ...
            "properties": {
                ...
                "status": {
                    "description": "'new', 'learning', 'learned'",
                    "type": "string"
                },
                "tags": {
                    "type": "array",
        ...
        "handlers.CreateUserCardRequest": {
            "type": "object",
            "required": [
                "card_id",
                "user_id"
        ...
        "handlers.StartTrainingSessionRequest": {
            "type": "object",
            "properties": {
                "course_id": {
                    "description": "int64, опционально",
        ...
        "handlers.UpdatePersonalVocabularyRequest": {
            "type": "object",
            "required": [
                "translation",
                "word"
        ...
        "handlers.UpdateUserCardRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "handlers.UpdateUserCourseRequest": {
            "type": "object",
            "properties": {
                "completed_decks_count": {
                    "type": "integer"
                },
                "progress_percentage": {
                    "type": "number"
        ...
        "handlers.UpdateUserDeckRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "role": {
                    "description": "'user' или 'admin' (в БД)",
                    "type": "string"
                },
                "role_id": {
                    "description": "1 для user, 2 для admin (вычисляемое)",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
